  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 text-sm text-primary/80 mb-3" style={{ filter: `drop-shadow(0 0 2px hsla(var(--primary), 0.5))`}}>
      ...
      <div className="container mx-auto px-4">
        ...
        {loading ? (
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-background/50 border border-primary/20 rounded-xl p-6 h-[450px] animate-pulse" />
            ))}
          </div>
        ) : (
          <motion.div 
