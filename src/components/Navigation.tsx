  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-background/80 backdrop-blur-xl border-b border-primary/10 shadow-[0_0_20px_hsla(198,93%,60%,0.1)]' : 'bg-transparent'
      }`}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <a href="#home" className="text-3xl font-bold font-heading tracking-wider" style={{ textShadow: '0 0 10px hsla(198, 93%, 60%, 0.7)'}}>
            Viet Dev
          </a>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Button variant="outline" className="border-primary text-primary hover:bg-primary/10 hover:text-primary animate-pulse hover:animate-none">
              {t('nav.hireMe')}
            </Button>
          </div>
