  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-primary/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-accent/20 to-primary/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-6 leading-tight animate-slide-up">
            {t('hero.greeting')} <span className="gradient-text animate-gradient">Viet Dev</span>
          </h1>
          
          <h2 className="text-2xl md:text-3xl font-bold mb-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            {t('hero.title')}
          </h2>
          
          <p className="text-xl md:text-2xl text-foreground/70 mb-12 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
            {t('hero.description')}
          </p>
