...
const Hero = () => {
  ...
  const NeoIcon = ({
    ...
    <a
      ...
      className="p-3 bg-background border-2 border-border text-foreground hover:bg-accent transition-all duration-200 neo-shadow hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[4px] active:translate-y-[4px]"
    >
    ...
    >
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <motion.div variants={itemVariants} className="text-foreground inline-block mb-6 border-2 border-border bg-background px-4 py-1 neo-shadow">
             <span className="text-sm font-bold uppercase tracking-wider">{t("project.softwareEngineer")}</span>
          </motion.div>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-foreground text-2xl md:text-4xl lg:text-5xl font-bold mb-8 font-mono bg-background border-2 border-border inline-block px-4 py-2 neo-shadow -rotate-1"
          >
            {t("hero.title")}
          </motion.h2>
          ...
          <motion.p
            variants={itemVariants}
            className="text-foreground text-xl md:text-2xl font-medium mb-12 max-w-2xl mx-auto leading-relaxed border-2 border-border p-6 bg-background neo-shadow"
          >
            {t("hero.description")}
          </motion.p>
