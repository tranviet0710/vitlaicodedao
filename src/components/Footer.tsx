      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-3xl font-bold font-heading mb-2" style={{ textShadow: '0 0 10px hsla(var(--primary), 0.7)'}}>Viet Dev</h3>
        ...
        <div className="mt-8 pt-8 border-t border-primary/20 text-center">
          <p className="text-foreground/60 flex items-center justify-center gap-2">
            Made with <Heart className="w-5 h-5 text-primary" style={{ filter: `drop-shadow(0 0 5px hsla(var(--primary), 1))`}} /> by Viet Dev © 2024. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
