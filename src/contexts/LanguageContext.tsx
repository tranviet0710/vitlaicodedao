...
const translations = {
  en: {
    ...
    'hero.description': 'Building innovative web solutions with modern technologies and AI integration',
    ...
    'projects.description': 'Here are some of my featured projects showcasing my skills and expertise.',
    'projects.viewDemo': 'View Demo',
    'projects.viewCode': 'View Code',
    'projects.viewAll': 'View All Projects',
    'projects.techStack': 'Tech Stack',
    'projects.notFoundDescription': 'The project you are looking for does not exist.',
    ...
    'contact.description': 'Do you need help with website development, app development, or technical consulting? Contact me now!',
    ...
    'contact.successMessage': 'Thank you for contacting me. I will respond as soon as possible.',
  ...
  vi: {
    ...
    'hero.title': 'Full-Stack Developer & AI Enthusiast',
    'hero.description': 'Xây dựng các giải pháp web sáng tạo với công nghệ hiện đại và tích hợp AI',
    ...
    'projects.description': 'Đây là một số dự án nổi bật của tôi, thể hiện kỹ năng và chuyên môn.',
    ...
    'contact.description': 'Bạn cần hỗ trợ phát triển website, app, hoặc tư vấn kỹ thuật? Hãy liên hệ ngay!',
    ...
    'contact.successMessage': 'Cảm ơn bạn đã liên hệ. Tôi sẽ phản hồi sớm nhất có thể.',
