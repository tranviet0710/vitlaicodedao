...
const translations = {
  en: {
    ...
    "admin.shortDescriptionHint": "Plain text summary shown on project cards and in search results.",
    "admin.caseStudy": "Case Study (rich content)",
    "admin.caseStudyHint": "Full write-up rendered on the project detail page. Supports Markdown, images, callouts and embeds.",
    ...
    "footer.copyright": "Copyright © 2026 Viet Dev.",
  ...
  vi: {
    ...
    "admin.shortDescription": "Mô tả ngắn",
    "admin.shortDescriptionHint": "Tóm tắt dạng văn bản thuần, hiển thị trên thẻ dự án và kết quả tìm kiếm.",
    "admin.caseStudy": "Case Study (nội dung chi tiết)",
    "admin.caseStudyHint": "Bài viết đầy đủ hiển thị ở trang chi tiết dự án. Hỗ trợ Markdown, hình ảnh, callout và nhúng video.",
    ...
    "footer.copyright": "Bản quyền © 2026 Viet Dev.",
