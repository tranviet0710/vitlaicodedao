  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Explore in-depth articles, tutorials, and insights on web development, React, Node.js, TypeScript, and modern software engineering practices."
        keywords="web development blog, React tutorials, Node.js guides, TypeScript tips, programming articles, software engineering"
        ogType="website"
        canonicalUrl="https://vitlaicodedao.tech/blogs"
      />
