...
// Google retired `embedding-001`; `gemini-embedding-001` is the replacement.
// It defaults to 3072 dimensions, so we ask for 768 to keep matching the
// `vector(768)` column on `documents`.
